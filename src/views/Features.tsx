  ...
  const mainFeatures = [
    {
      ...
      description:
        "Get detailed insights with real-time click tracking, geographic data, device information, and referrer analysis.",
      features: [
        "Real-time tracking",
        "Geographic insights",
        "Device analytics",
    ...
    },
    {
      ...
      description:
        "Bank-level encryption with SSL certificates, fraud protection, and compliance with international security standards.",
      features: [
        "SSL encryption",
        "Fraud protection",
        "GDPR compliant",
    ...
    },
    {
      ...
      description:
        "Use your own branded domain for professional short links that build trust and enhance your brand recognition.",
      features: [
        "Custom branding",
        "SSL certificates",
        "DNS management",
  ...
  const additionalFeatures = [
    {
      ...
      desc: "Global CDN with <100ms redirects",
    },
    {
      icon: FiSmartphone,
    ...
    },
    {
      ...
      desc: "Share and manage links together",
    },
    {
      icon: FiCode,
      title: "Developer API",
      desc: "RESTful API with full documentation",
    },
    {
      icon: FiSettings,
      title: "Advanced Controls",
      desc: "Password protection & expiration",
    },
    {
      icon: FiTrendingUp,
      title: "Growth Insights",
      desc: "AI-powered performance analytics",
    },
    {
      icon: FiLock,
      title: "Privacy First",
    ...
    },
    {
      ...
      desc: "Schedule links for future activation",
    },
    {
      icon: FiTarget,
      title: "A/B Testing",
      desc: "Test different destinations",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            collaboration, we've got all the tools you need to optimize your
            online presence.
          </p>
        </div>
