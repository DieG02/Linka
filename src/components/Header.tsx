...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-white/95 border-b border-gray-100 fixed w-full top-0 z-50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-slate-800 to-slate-700 bg-clip-text text-transparent -tracking-wide">
                Linka
              </span>
            </div>
