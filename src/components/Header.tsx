    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex space-x-12">
              <a href="#" className="relative text-gray-700 hover:text-indigo-600 transition-colors font-medium text-lg group py-2">
                Features
      ...
      {isMenuOpen && (
        <>
          ...
          {/* Drawer */}
          <div className="fixed top-20 right-0 w-80 h-full bg-white/95 backdrop-blur-xl border-l border-gray-200 z-50 md:hidden animate-slide-in-right shadow-2xl">
            <div className="p-8 space-y-8">
              <nav className="space-y-6">
                <a href="#" className="block text-xl font-medium text-gray-700 hover:text-indigo-600 transition-colors py-3 border-b border-gray-100">
                  Features
                </a>
                <a href="#" className="block text-xl font-medium text-gray-700 hover:text-indigo-600 transition-colors py-3 border-b border-gray-100">
                  Analytics
